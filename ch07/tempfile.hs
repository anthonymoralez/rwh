...
{- The guts of the program. Called with the path and handle of a temporary
 - file. When this function exits, that file will be closed and delted
...
myAction tempname temph =
    do -- Start by displaying a greeting on the terminal
       ...
       -- in memory, bu makes the "pos" correspond to a different
       ...
       -- Copy the file byte-for-byte to stdout, followed by a \n
       putStrLn c
